...
namespace MiniMappingway.Api
{
    ...
    /// </summary>
    /// <remarks>
    /// I might add more methods for adding to list of player names instead of specific references to player objects. These would then be scanned by mini-mappingway on my behalf. If you would like this let me know.
    /// </remarks>
